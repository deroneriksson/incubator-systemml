...
public class BasicConfigurationManager 
{
	...
	private static BasicDMLConfig _dmlconf = null; 
	 ...
	 */
	public synchronized static void setGlobalConfig( BasicDMLConfig conf ) {
		_dmlconf = conf;
	 ...
	 * @param conf the configuration
	 */
	public static void setLocalConfig( BasicDMLConfig conf ) {
		_ldmlconf.set(conf);
	}
	 ...
	 */
	public static BasicDMLConfig getDMLConfig() {
	...
	private static class ThreadLocalDMLConfig extends ThreadLocal<BasicDMLConfig> {
		@Override 
        protected BasicDMLConfig initialValue() { 
