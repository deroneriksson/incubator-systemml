...
public class RunMRJobs 
{
	 ...
	 * @return replacement string for variable name
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	 ...
	 * @param inst instruction
	 * @param map local variable map
	 * @return instruction with all placeholder strings replaced
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	 ...
	 *  
	 * @param instList list of instructions
	 * @param labelValueMapping local variable map
	 * @return instructions with all placeholder labels replaced
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
