...
public class DMLProgram 
{
	...
	/**
	 * Obtain function statement block from fkey
	 * 
	 ...
	 * 
	 * @param in input variable set
	 * @param out output variable set
	 * @param kill kill variable set
	 ...
	 * @return true if block contains rmvar or rmfilevar instruction for the given variable name, false otherwise
	 */
