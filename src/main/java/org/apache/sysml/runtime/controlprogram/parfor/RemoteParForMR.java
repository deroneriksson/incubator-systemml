...
public class RemoteParForMR
{
		...
		throws DMLRuntimeException
	{
		...
		try
		{
			...
			//job.setInt("mapred.map.tasks.maximum", 1); //system property - MR1
			//job.setInt("mapred.tasktracker.tasks.maximum",1); //system property - typo? mapred.tasktracker.map.tasks.maximum deprecated
			//job.setInt("mapred.jobtracker.maxtasks.per.job",1); //system property - deprecated
			...
			String memKey = MRConfigurationNames.MAPRED_CHILD_JAVA_OPTS;
