...
public class MatrixBlock extends MatrixValue implements CacheBlock, Externalizable
{
	 ...
	 * 
	 * @return maximum row within current block
	 */
	 ...
	 * 
	 * @return maximum column within current block
	 */
	 ...
	 * 
	 * @return reduceall-min of matrix
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	public double min() 
		throws DMLRuntimeException
	 ...
	 * 
	 * @return reduceall-max of a matrix
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	public double max() 
		throws DMLRuntimeException
	 ...
	 * 
	 * @return true if current representation is sparse
	 */
	...
	/**
	 * 
	 * @return true if representation is ultra sparse
	 */
	 ...
	 * 
	 * @return true if should be in sparse format in memory
	 */
	 ...
	 * or hdfs. 
	 * 
	 * @return true if should be in sparse format on disk
	 */
	 ...
	 * @param appendOnly true if append only
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	 ...
	 * 
	 * @param op operator
	 * @param scalarThat double
	 * @param that2Val matrix value
	 * @param resultMap the ctable map
	 * @param resultBlock matrix block
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	@Override
	 ...
	 * 
	 * @param op operator
	 * @param ix1 matrix indexes
	 * @param scalarThat double
	 * @param left true if left
	 * @param brlen row block length
	 * @param resultMap the ctable map
	 * @param resultBlock matrix block
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	 ...
	 * 
	 * @param op operator
	 * @param thatVal matrix value
	 * @param scalarThat2 double
	 * @param ignoreZeros true if ignore zeros
	 * @param resultMap the ctable map
	 * @param resultBlock matrix block
	 * @throws DMLRuntimeException if DMLRuntimeException occurs
	 */
	 ...
	 * @param min minimum
	 * @param max maximum
	 * @param pdf probability distribution
	 ...
	 * 
	 * @param rgen random matrix generator
	 * @param nnzInBlock number of non-zeros in block
	 * @param bigrand Well 1024a pseudo random number generator
